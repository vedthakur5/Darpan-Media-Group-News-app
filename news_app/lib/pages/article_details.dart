...
class _ArticleDetailsState extends State<ArticleDetails> {
  ...
  void _handleShare() {
    ...
    if (Platform.isAndroid) {
      Share.share('${widget.data.title}, Check out this app to explore more. App link: https://play.google.com/store/apps/details?id=${sb.packageName}');
    } else {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      ...
      minimum: EdgeInsets.only(bottom: ab.bannerAd == true ? Platform.isAndroid ? 60 : 80 : 0),
          child: Scaffold(
          body: Column(
        children: [
          Expanded(
