  ...
  handleSendNotification () async{
    ...
    if(formKey.currentState.validate()){
      ...
      if (ab.userType == 'tester') {
        ...
        await getTimestamp()
        .then((value) => context.read<NotificationBloc>().sendNotification(titleCtrl.text, imageCtrl.text))
    ...
    showDialog(
      ...
      builder: (context){
        return SimpleDialog(
            ...
            children: <Widget>[
              Text('Send Push Notification to All Users', style: TextStyle(fontSize: 30, fontWeight: FontWeight.w900),),
              SizedBox(height: 50,),
              Form(
                key: formKey,
                child: Column(children: <Widget>[
                  ...
                  TextFormField(
                    decoration: inputDecoration('Enter Image URL stored in firebase', 'Image', imageCtrl),
                    controller: imageCtrl,
                    validator: (value) {
                      if (value.isEmpty) return 'No Image';
                      return null;
                    },
